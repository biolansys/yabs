<HTML>
  ...
  <textarea name="textarea"   cols="90" rows="29" wrap=off>
<?php
...
<input class='estilo004' type="Submit" value="Save to file" > <input class='estilo004' type="Text" name="file"  size="15" value="blast.txt">
</form> 
</BODY>
</HTML>