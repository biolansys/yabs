<HTML>
  ...
  <center>
   <table  CELLSPACING=0 CELLPADDING=4 border=0  bgcolor=#FFFFFF  width=99% height=100%>
     <tr height=1%><td class=tr0>Species Set Linked to Compara Methods</td></tr>
    <tr valign=top  height=1%>
       <td  >  <center>
         <form  method='POST' action="rest0080.php " target=ff001>
         ...
         <table border=0 CELLSPACING=1 CELLPADDING=2 class=tabla0>
           ...
           <td align=right>  Method:             </td>
             <td align=left> <select class='estilo004' name="method" >
                      ...
                      <option  value="NC_TREES"> NC_TREES </option>
                      ...
                      <option          value="LASTZ_PATCH"> LASTZ_PATCH</option>
                      
                       <option          value="PROTEIN_TREES"> PROTEIN_TREES</option>
                   </select>      
             </td>
           <tr class=tr_titulo0>
