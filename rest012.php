<HTML>
  ...
  <center>
   <table  CELLSPACING=0 CELLPADDING=4 border=0  bgcolor=#FFFFFF  width=99%>
     <tr ><td class=tr0>Get Information from External primary accession or display label</td></tr>
    <tr valign=top  >
       <td  >  <center>
         <form  method='POST' action="rest0120.php " target=ff001>
         ...
         <table border=0 CELLSPACING=1 CELLPADDING=2 class=tabla0>
           <tr align=center>
             ...
             <td> <input type="Text" name="species"  size="30" value="human">  </td>
           </tr>
            <tr align=center>
             <td align=right>  External primary accession or display label:             </td>
             <td> <input type="Text" name="name"  size="30" value="BRCA2">  </td>
           </tr>
           <tr class=tr_titulo0>
