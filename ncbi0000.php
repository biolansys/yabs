...
?>   
   ...
   'http://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=<?echo $db?>&id=<?echo $id?>&strand=<?echo $strand?>&seq_start=<?echo $start?>&seq_stop=<?echo $stop?>&rettype=<?echo $rettype?>&retmode=text&complexity=<?echo $complexity?>'
   )</script>
  </BODY>
</HTML>
