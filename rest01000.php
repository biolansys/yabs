...
?>   
   <script>window.location.href =('http://rest.ensembl.org/homology/id/<? echo trim($id)?>?content-type=application/json;sequence=<?echo trim($sequence)?>;type=<?echo trim($type)?>')</script>
  </BODY>
</HTML>
