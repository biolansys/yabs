<HTML height=100%>
  ...
  <BODY   topmargin="5" leftmargin="0" rightmargin=0 height=100%>
  <center>
   <table  CELLSPACING=0 CELLPADDING=4 border=0  bgcolor=#FFFFFF   width=99%>
     <tr ><td class=tr0>Get Features by Region in gff3 format</td></tr>
    <tr valign=top  >
       <td  >  <center>
         <form  method='POST' action="rest0150.php " target=ff001>
         ...
         <table border=0 CELLSPACING=1 CELLPADDING=2 class=tabla0>
           <tr align=center>
             ...
             <td align=left> <select class='estilo004' name="feature" >
                      <option selected value="gene;feature=transcript;feature=cds;feature=exon"> gene/transcript/cds/exon </option>
      ...
      <tr> 
       <td   >
         <iframe name=ff001 src='' width=100% height=550 scrolling="auto" frameborder=0> </iframe> 
       </td>
      </tr>
    </table>
  </BODY>
