<HTML>
  ...
  <center>
   <table  CELLSPACING=0 CELLPADDING=4 border=0  bgcolor=#FFFFFF  width=99%  height=100%>
     <tr  height=1%><td class=tr0>
      <A HREF="http://togows.dbcls.jp" target=_blank >TogoWS</a>
      entry retrieval</td></tr>
    <tr valign=top   height=1%>
       <td  >  <center>
         <form  method='POST' action="togows001.php " target=ff001>
         ...
         <table border=0 CELLSPACING=1 CELLPADDING=2 class=tabla0>
           <tr align=left>
             ...
             <td colspan=3> <input type="Text" name="id"  size="50" value="A1AG1_HUMAN,A1AG1_MOUSE">  </td>
