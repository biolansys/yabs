<HTML>
  ...
  <center>
   <table  CELLSPACING=0 CELLPADDING=4 border=0  bgcolor=#FFFFFF   width=99%  height=100%>
     <tr  height=1%><td class=tr0>Get Variation by ID/Species</td></tr>
    <tr valign=top   height=1%>
       <td  >  <center>
         <form  method='POST' action="rest0200.php " target=ff001>
         ...
         <table border=0 CELLSPACING=1 CELLPADDING=2 class=tabla0>
           <tr align=center>
             ...
             <td> <input type="Text" name="id"  size="25" value="rs56116432">  </td>
             <td align=right>  Species:             </td>
             <td align=left> <input type="Text" name="species"  size="20" value="homo_sapiens">  </td>
