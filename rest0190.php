...
<?  
   ...
   $service_url = 'http://rest.ensembl.org/homology/symbol/'.trim($species).'/'.trim($id).'?content-type=application/json;sequence='.trim($sequence).
                  ';type='.trim($type) ;
   //echo $service_url;
   ...
   echo "<tr class=tr_titulo><td colspan=6  > Homolgy by Symbol";  
