<HTML>
  ...
  <center>
   <table  CELLSPACING=0 CELLPADDING=4 border=0  bgcolor=#FFFFFF  width=99%>
     <tr ><td class=tr0>Genomic Align by Slice</td></tr>
    <tr valign=top  >
       <td  >  <center>
         <form  method='POST' action="rest0060.php " target=ff001>
         ...
         <table border=0 CELLSPACING=1 CELLPADDING=2 class=tabla0>
           <tr align=center>
             ...
             <td> <input type="Text" name="species"  size="30" value="mammals">  </td>
             <td align=right>  Region:             </td>
             <td> <input type="Text" name="region0"  size="30" value="homo_sapiens">  </td>
             <td> <input type="Text" name="region1"  size="30" value="X:20000000-20000100:1">  </td>
           </tr>
           <td align=right> Format:             </td>
             <td align=left> <select class='estilo004' name="nh_format" >
                      <option selected value="simple"> pantalla </option>
