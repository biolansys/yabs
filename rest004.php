<HTML>
  ...
  <center>
   <table  CELLSPACING=0 CELLPADDING=4 border=0  bgcolor=#FFFFFF   width=99%>
     <tr ><td class=tr0>Get Gentree by Symbol</td></tr>
    <tr valign=top  >
       <td  >  <center>
         <form  method='POST' action="rest0040.php " target=ff001>
         ...
         <table border=0 CELLSPACING=1 CELLPADDING=2 class=tabla0>
           <tr align=center>
             ...
             <td> <input type="Text" name="species"  size="30" value="homo_sapiens">  </td>
             
             <td align=right>  Symbol:             </td>
             <td> <input type="Text" name="symbol"  size="30" value="BRCA2">  </td>
