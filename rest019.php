<HTML>
  ...
  <center>
   <table  CELLSPACING=0 CELLPADDING=4 border=0  bgcolor=#FFFFFF  width=99%  height=100%>
     <tr  height=1%><td class=tr0>Homology by Symbol</td></tr>
    <tr valign=top   height=1%>
       <td  >  <center>
         <form  method='POST' action="rest0190.php " target=ff001>
         
         <table border=0 CELLSPACING=1 CELLPADDING=2 class=tabla0>
           <tr>
            <td align=right>  Gene Symbol:             </td>
             <td> <input type="Text" name="id"  size="30" value="BRCA2">  </td> 
            <td align=right>  Sequence:             </td>
             ...
             <td align=left> <select class='estilo004' name="type" >
                      <option   value="orthologues"> Orthologues </option>
