<HTML>
  ...
  <center>
   <table  CELLSPACING=0 CELLPADDING=4 border=0  bgcolor=#FFFFFF  width=99% height=100%>
     <tr height=10 ><td class=tr0  >Get Overlap by region</td></tr>
    <tr valign=top  height=10>
       <td  >  <center>
         <form  method='POST' action="rest0170.php " target=ff001>
         ...
         <table border=0 CELLSPACING=1 CELLPADDING=2 class=tabla0>
          <tr align=center>
             ...
             <td> <input type="Text" name="specie"  size="30" value="human">  </td>
           </tr>
           <tr align=center>
             <td align=right>  Region:             </td>
             <td> <input type="Text" name="region"  size="30" value="7:140424943-140624564">  </td>
           </tr>
           
           <tr align=center>
             <td align=right>  Feature:             </td>
             <td> <input type="Text" name="feature"  size="30" value="gene,exon,transcript">  </td>
           </tr>
           <tr align=center>
             <td align=right>  Output:             </td>
             <td align=left> <select class='estilo004' name="output" >
