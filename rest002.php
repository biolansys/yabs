<HTML>
  ...
  <center>
   <table  CELLSPACING=0 CELLPADDING=4 border=0  bgcolor=#FFFFFF   width=99%  height=100%>
     <tr  height=1%><td class=tr0>Get Sequence by Region</td></tr>
    <tr valign=top   height=1%>
       <td  >  <center>
         <form  method='POST' action="rest0020.php " target=ff001>
         ...
         <table border=0 CELLSPACING=1 CELLPADDING=2 class=tabla0>
           <tr align=center>
             ...
             <td align=left> <input type="Text" name="species"  size="20" value="human">  </td>
              <td align=right>  Coord Sys Ver:             </td>
             <td align=left> <input type="Text" name="db_type"  size="20" value="GRCh37">  </td>
           </tr>
           <tr class=tr_titulo0>
