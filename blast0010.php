    ...
    <STYLE type="text/css">
      ...
      A:hover   {font-size:12;font-family:calibri;text-decoration:none;color: rgb(51,102,153);border-style: groove ;border-width: 0px 0px 0px 0px}
       ...
       <script type="text/javascript">
         function delayer(){
           window.location = "blast0010.php?jobId=<?echo $jobId?>"
         }
       </script>
    </HEAD>
<body class=cuerpo1 topmargin="08" leftmargin="0" righmargin=0 onLoad="setTimeout('delayer()', 5000)">
<center>
<?php
...
<form method="POST" action="blast00100.php" target=_blank> 
  ...
  <tr>
    <td class=td_titulo colspan=2> <center><b>
        This page refresh every 5 secs until job finish
    </td>
  </tr>
  <tr >
   ...
   <?if ($result=='FINISHED') {?>
     <script>window.location.href =("blast0011.php?jobId=<?echo $jobId?>")</script>
   <?} ?>
    <?if ($result=='FAILURE') {?>
     <script>window.location.href =("blast0012.php?jobId=<?echo $jobId?>")</script>
   <?} ?>
 </table>
</form>    
